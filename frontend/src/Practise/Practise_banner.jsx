...
import Notes_card from "../Notes/Notes_card";
import Practise_card from "./Practise_card";

const Practise_banner = () => {
    ...
    <>
      ...
      <section className="max-w-screen-2xl px-10 container  dark:text-white">
        <div className="mx-auto my-16 max-w-screen-xl px-4 py-4 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="mx-auto max-w-lg text-center">
            <h2 className="text-3xl font-bold sm:text-4xl">Time for practise</h2>
            <p className="mt-4 text-red-300">For class XI</p>
          </div>
        </div>
        <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-8 ">
          {shfData.map((shfData) => (
            <Practise_card key={shfData.id} items={shfData} grade="XIP" />
          ))}
        </div>
      </section>
      ...
      <section className="max-w-screen-2xl px-10 my-10 container  dark:text-white">
        ...
        <div className="mt-2 grid grid-cols-1 md:grid-cols-4 gap-8 ">
          {shfData.map((shfData) => (
            <Practise_card key={shfData.id} items={shfData} grade="XIIP" />
          ))}
        </div>
      </section>
    </>
...
export default Practise_banner;
